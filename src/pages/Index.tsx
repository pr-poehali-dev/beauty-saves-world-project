...
const services = [
  {
    ...
    icon: "Sparkles",
    items: [
      { name: "Брови (пудровая техника)", price: "6 000 ₽", duration: "2–3 часа", desc: "Натуральный эффект пудры, идеальная форма под ваш тип лица" },
      ...
      { name: "Губы (акварельные)", price: "6 000 ₽", duration: "2–3 часа", desc: "Нежный цвет по всей поверхности, эффект тинта" },
        ...
        <div className="container mx-auto px-6 md:px-12 pt-24 pb-12 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            <div className="animate-slide-up-delay-3 flex gap-8 mt-12">
              {[["5000+","клиентов"],["5","лет опыта"],["3","направления"]].map(([n, l]) => (
                <div key={l}>
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { icon: "Phone", label: "Телефон", value: "+7 (983) 399-35-07", sub: "Ежедневно 10:00 – 20:00", color: "#b24bff" },
